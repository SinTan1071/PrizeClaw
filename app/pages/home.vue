<template>
 ...
 <!--            <img class="img_outside" style="width:100%;height:auto" src="../images/home/outside.png" /> -->
            <div class="nav" style="display:flex">
                <div class="nav-left" style="display:inline-block;flex:1">
                    <span class="left-font">小米专场</span>
                  <!--   <img src="../images/home/nav_light.png" style="width:120px;height:43px" /> -->
                </div>
                 <div class="nav-middle"  style="display:inline-block;flex:1">
                    <span class="middle-font" >苹果7P 专场  </span>
                    <p style="font-size:10px" class="middle-font-two">150金币／次</p>
            ...
            <div style="padding: 300px 27px 0 27px">
                <img src="../images/home/Conveyor.png"  style="width:100%;height:43px" />
            </div>
            <div style="padding: 0px 27px 0 27px;margin-top: 20px">
                <img src="../images/home/Conveyor.png"  style="width:100%;height:43px" />
            </div>
        ...
        <!--<mt-tabbar v-model="selected">-->
            <!--<mt-tab-item id="游戏">-->
                <!--<img slot="icon" src="../images/home/game.png">-->
                <!--游戏-->
            <!--</mt-tab-item>-->
            <!--<mt-tab-item id="领取金币">-->
                ...
                <!--领取金币-->
            <!--</mt-tab-item>-->
            <!--<mt-tab-item id="我的" @click="myAccount">-->
